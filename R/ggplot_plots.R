...
# #' @export
# #'
gg_plotsim_mayssa <- function(varsim, simmoy, simsd, name = " ", col="blue", colref="red")
{
  var_ <- varsim
...
# #' @export
# #'
gg_addplotobs_mayssa <- function(plot_var, var_, obsOK, obsMerge)
{
...
# #' @export
# #'
gg_plotsimVar_mayssa <- function(varsim, simmoy, simmoy_, simsd, simsd_)
{
  var_ <- varsim
...
#pas fourni d'exemple d'utilisation...
