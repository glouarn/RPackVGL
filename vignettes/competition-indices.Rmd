...
#rmixan$RYtheol <- rmixan$propLuz
#rmixan$RYtheog <- 1-rmixan$propLuz


#rmixan$deltaRYl <- rmixan$RYl - rmixan$RYtheol #pas bon -> cf plus loin
#rmixan$deltaRYg <- rmixan$RYg - rmixan$RYtheog #pas bon -> cf plus loin
